...
export const HowIWorkSection: React.FC<HowIWorkSectionProps> = ({ currentLang }) => {
  return (
    <section id="workflow" className="py-16 sm:py-24 md:py-32 relative border-t border-[var(--border-color)] bg-[var(--bg-primary)]">
      <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 relative z-10">
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6 items-start">
                ...
                <div className="lg:col-span-3 flex items-center lg:flex-col lg:items-start gap-3">
                  <span className="font-gost text-3xl sm:text-5xl font-black text-[var(--accent-blue)]">
                    {step.number}
                  </span>
                  <div>
                    <span className="text-xs sm:text-sm font-mono font-bold tracking-widest text-[var(--text-secondary)] uppercase block">
                ...
                <div className="lg:col-span-5">
                  <h3 className="font-gost text-lg sm:text-xl lg:text-2xl font-black text-[var(--text-primary)] mb-2 group-hover:text-[var(--accent-blue)] transition-colors leading-snug">
                    {step.title[currentLang]}
                  </h3>
                  <p className="text-sm sm:text-base lg:text-lg text-[var(--text-secondary)] leading-relaxed font-normal">
                    {step.description[currentLang]}
                  </p>
                </div>

                {/* Deliverables */}
                <div className="lg:col-span-4 bg-[var(--bg-surface-2)] p-4 sm:p-5 lg:p-6 rounded-2xl border border-[var(--border-color)]">
                  <div className="text-xs sm:text-sm font-mono uppercase tracking-wider text-[var(--accent-blue)] font-extrabold mb-2.5 sm:mb-3">
        ...
        <div className="bg-[var(--glass-bg)] border border-[var(--border-color)] rounded-3xl p-6 sm:p-8 md:p-12 backdrop-blur-xl shadow-lg flex flex-col md:flex-row items-center justify-between gap-5 sm:gap-6 transition-all duration-300 ease-out hover:scale-[1.01] sm:hover:scale-[1.025] hover:-translate-y-1 hover:shadow-2xl hover:border-[var(--accent-blue)] cursor-pointer">
          <div className="max-w-xl">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-[var(--text-secondary)] font-medium leading-relaxed">
