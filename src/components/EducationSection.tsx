...
export const EducationSection: React.FC<EducationSectionProps> = ({ currentLang }) => {
  return (
    <section id="education" className="py-16 sm:py-24 md:py-32 relative border-t border-[var(--border-color)] bg-[var(--bg-primary)]">
      <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12 sm:mb-16">
          ...
          <div className="flex flex-wrap items-center gap-2.5 sm:gap-3">
            <div className="text-xs sm:text-sm lg:text-base font-gost-mono text-[var(--text-secondary)] bg-[var(--bg-surface-2)] border border-[var(--border-color)] px-4 sm:px-5 py-2 sm:py-2.5 rounded-full font-bold shadow-sm">
            ...
            <div className="text-xs sm:text-sm lg:text-base font-gost-mono text-[var(--accent-blue)] bg-[var(--badge-bg)] border border-[var(--border-color)] px-4 sm:px-5 py-2 sm:py-2.5 rounded-full font-bold shadow-sm flex items-center gap-2">
              <ShieldCheck className="w-4 sm:w-4.5 h-4 sm:h-4.5" />
        ...
        <div className="mb-12 sm:mb-16">
          <div className="text-xs sm:text-sm lg:text-base font-black uppercase tracking-wider text-[var(--text-secondary)] mb-5 sm:mb-6 flex items-center gap-2.5">
            ...
            {EDUCATION_DATA.map((item, index) => (
              ...
              >
                <div>
                  ...
                  {item.details && (
                    <p className="text-xs sm:text-sm lg:text-base text-[var(--text-secondary)] leading-relaxed pt-3 border-t border-[var(--border-color)] font-normal">
        ...
        <div className="mb-12 sm:mb-16">
          <div className="text-xs sm:text-sm lg:text-base font-black uppercase tracking-wider text-[var(--text-secondary)] mb-5 sm:mb-6 flex items-center gap-2.5">
            <BookmarkCheck className="w-4.5 h-4.5 text-[var(--accent-blue)]" />
              ...
              >
                <div>
                  <div className="flex items-center justify-between gap-2 mb-3.5">
                    ...
                    <span className="text-[11px] sm:text-xs lg:text-sm font-gost-mono text-[var(--text-secondary)] bg-[var(--bg-surface-2)] border border-[var(--border-color)] px-2.5 sm:px-3 py-1 rounded-full font-bold">
                      {cert.badge[currentLang]}
                    </span>
                  </div>

                  <h3 className="font-gost text-base sm:text-lg lg:text-xl font-black text-[var(--text-primary)] group-hover:text-[var(--accent-blue)] transition-colors mb-1.5 leading-snug">
                    {cert.name[currentLang]}
                  </h3>

                  <div className="text-xs sm:text-sm lg:text-base font-bold text-[var(--accent-blue)] mb-2.5 sm:mb-3 leading-snug">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 sm:gap-6">
          <div className="lg:col-span-2 p-5 sm:p-7 lg:p-8 bg-[var(--glass-bg)] border border-[var(--border-color)] rounded-3xl backdrop-blur-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 sm:gap-6 shadow-sm transition-all duration-300 ease-out hover:scale-[1.01] sm:hover:scale-[1.02] hover:-translate-y-1 hover:shadow-2xl hover:border-[var(--accent-blue)] cursor-pointer">
            <div className="flex items-center gap-3.5 sm:gap-4">
              ...
              <div>
                <div className="text-xs sm:text-sm font-mono uppercase text-[var(--accent-blue)] font-black tracking-wider mb-1">
                ...
                <div className="text-sm sm:text-base lg:text-lg text-[var(--text-primary)] font-medium leading-relaxed">
                  {currentLang === 'uk' 
            ...
            <span className="text-xs sm:text-sm lg:text-base font-mono text-[var(--text-secondary)] bg-[var(--bg-surface-2)] px-3.5 sm:px-4.5 py-2 sm:py-2.5 rounded-full border border-[var(--border-color)] whitespace-nowrap font-bold">
          ...
          <div className="p-5 sm:p-7 lg:p-8 bg-[var(--glass-bg)] border border-[var(--border-color)] rounded-3xl backdrop-blur-xl flex items-center gap-3.5 sm:gap-4 shadow-sm transition-all duration-300 ease-out hover:scale-[1.01] sm:hover:scale-[1.02] hover:-translate-y-1 hover:shadow-2xl hover:border-[var(--accent-blue)] cursor-pointer">
            ...
            <div>
              ...
              <div className="text-xs sm:text-sm lg:text-base text-[var(--text-primary)] font-medium leading-relaxed">
                {currentLang === 'uk'
